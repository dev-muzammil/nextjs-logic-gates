        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-0 md:mb-0 items-center">
            ...
            <p className="mb-8 leading-relaxed text-md sm:text-xl font-semibold  text-center md:text-left">
              A NAND gate is a logical gate that performs the negation of the
              AND operation. It produces a high output (1) only when both of its
              inputs are low (0). If any input is high (1), the output will be
              low (0).
            </p>
            <ul className="list-disc font-semibold text-md sm:text-lg sm:mx-0 mx-4">
              ...
              <li>It produces a low output (0) if any input is high (1).</li>
            </ul>
          </div>
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
            ...
            >
              <h1 className="text-center text-3xl font-extrabold">NAND Gate</h1>
